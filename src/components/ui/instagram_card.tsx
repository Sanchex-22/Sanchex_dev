...
export const InstaPost: React.FC<InstaPostProps> = ({data}) => {
    return (
        <div className="bg-slate-900 w[250px]">
            <div>
                <div className="p-3 px-6 min-h-48 flex justify-center items-center" style={{ cursor: 'auto' }}>
                    <div>
                        <div className="rounded-md shadow-md sm:w-72 bg-coolGray-900 text-coolGray-100">
                            <div className="flex items-center justify-between p-3" style={{ cursor: 'auto' }}>
                                <div className="flex items-center space-x-2" style={{ cursor: 'auto' }}>
                                    ...
                                    <div className="-space-y-1" style={{ cursor: 'auto' }}>
                                        <h2 className="text-sm font-semibold leading-none" style={{ cursor: 'auto' }}>o</h2>
                                        <span className="inline-block text-xs leading-none text-coolGray-400" style={{ cursor: 'auto' }}>{data?.place} </span>
                                    </div>
                                </div>
                            ...
                            <div className="p-3" style={{ cursor: 'auto' }}>
                                ...
                                <div className="flex flex-wrap items-center pt-3 pb-1" style={{ cursor: 'auto' }}>
