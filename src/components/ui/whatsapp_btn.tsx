export default function WhatsAppBtn (){
    ...
    <div
        id="whatsapp-button"
        className="btn-whatsapp-pulse-border fixed bottom-2 right-2 z-50 grid place-items-center rounded-full bg-jazzberry-jam-600 shadow-md transition duration-300 ease-in-out hover:-translate-y-1 md:bottom-6 md:right-6 print:hidden"
      >
        <a
          href={`#`}
          target="_blank"
        ...
        >
          ...
          <span
            className="absolute -right-0 -top-2 rounded-full bg-red-500 p-0.5 px-2 text-sm text-red-50"
            >1</span>
        </a>
      </div>
    )
